		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bin.to.Bin",
									"targetURL": "#bintobinbintobin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bintobinbintobin-display": {
								"semanticObject": "bintobinbintobin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bintobin.bin.to.bin",
									"url": sap.ui.require.toUrl("bintobin/bin/to/bin")
								}
							}
						}
					}
